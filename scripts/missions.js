...
function mission_planet_desc(planet) {
    var pnum;
...
function constrictor_mission_brief() {
    var rotmat;
...
function constrictor_mission_debrief() {
    var keyasc;
...
function thargoid_mission_first_brief() {
    var keyasc;
...
function thargoid_mission_second_brief() {
    var keyasc;
...
function thargoid_mission_debrief() {
    var keyasc;
