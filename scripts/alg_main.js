...
function save_commander_screen ()
{
    var path;
    var okay;
    var rv;
...
function load_commander_screen ()
{
    var path;
    var rv;
...
function run_first_intro_screen ()
{
    current_screen = SCR_INTRO_ONE;
...
function run_second_intro_screen ()
{
...
function display_break_pattern ()
{
    var i;
